...
public class SecuritySystemRulesTest extends MyTestHelper {
	...
	@Test
	public void testAlarmArmedAwayByEmail() throws Exception {
		KieSession ksession = testHelper("Update Device Status.drl", "Security System Rules.drl");
	...
	@Test
	public void testAlarmArmedStayByEmail() throws Exception {
		KieSession ksession = testHelper("Update Device Status.drl", "Security System Rules.drl");
	...
	@Test
	public void testAlarmDisarmedByEmail() throws Exception {
		KieSession ksession = testHelper("Update Device Status.drl", "Security System Rules.drl");
